          ...
          <SwiperSlide key={banner.id}>
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${getStorageUrl(banner.imageUrl)})`,
              ...
              <div className="absolute left-8 sm:left-20 md:left-28 lg:left-40 top-1/4 container mx-auto">
                <span 
                  className="text-[#CB6406] text-base sm:text-lg md:text-xl lg:text-2xl font-medium mb-2 sm:mb-3 block 
                    opacity-0 animate-[fadeInUp_0.8s_0.3s_forwards]"
                >
                  GRANDES EN
                </span>
                <h1 
                  className="text-[#1a1a1a] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6
                    opacity-0 animate-[fadeInUp_0.8s_0.5s_forwards]"
                >
                  BUENOS
                  <br />
                  PRECIOS 
                ...
                <button 
                  className="
                    ...
                    opacity-0 animate-[fadeInUp_0.8s_0.7s_forwards]
                "
                >
                  CONTÁCTANOS
                </button>
